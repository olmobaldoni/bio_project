...
def run_more_self_eval(method_name, checkpoint_steps=None):
    ...
    for prompt in edit_prompts:
        ...
        for target_name in target_names:
            ...
            avg_fid = fid.main(prompt_target_dir, full_target_dir)
            avg_clip = clip_distance.main(prompt_target_dir, full_target_dir)
...
if __name__ == "__main__":
    ...
    run_more_self_eval(args.method_name, checkpoint_steps=args.checkpoint_steps)
